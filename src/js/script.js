...
const app = document.querySelector(".app__main");
const themeName = document.querySelector(".theme__name");
const themeSvg = document.querySelector(".theme__icon");
  ...
  const html = `
        ...
        <img class="user-img" src="${user.avatar_url}" alt="Profile picture of ${user.name}" />
          ...
          <ul class="info">
            ...
            <li>
              <svg
                aria-label="Name of this user on twitter"
                height="18"
                width="20"
                xmlns="http://www.w3.org/2000/svg"
              >
              ...
              <a href="#" class="info__twitter">${twitter}</a>
            </li>
            <li>
              <svg
                aria-label="Personal website of this user"
                height="20"
                width="20"
                xmlns="http://www.w3.org/2000/svg"
              >
...
const getUser = async function (user) {
  try {
    ...
    document.querySelector(".form__error").classList.add("form__error--active");
  }
};
...
searchBtn.addEventListener("click", function (e) {
  ...
  document
    ...
    .classList.remove("form__error--active");
});
